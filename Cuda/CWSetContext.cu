...
extern "C"
{
	...
	__global__ void CWSetContext(float *activations, float *contextActivations, int *periods, int simulationStep)
	{
		...
		if (id < D_HIDDEN_UNITS * D_NEURON_GROUPS && simulationStep % periods[unitID] != 0)
		{
